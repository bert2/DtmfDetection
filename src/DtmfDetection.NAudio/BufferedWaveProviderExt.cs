namespace DtmfDetection.NAudio {
    ...
    public static class BufferedWaveProviderExt {
        /// <summary>Blocks the thread for as long as the `BufferedWaveProvider` minimally should need to buffer at least `count` sample frames.
        /// The wait time is estimated from the difference of the number of already buffered bytes to the number of requested bytes.</summary>
