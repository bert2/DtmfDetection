namespace DtmfDetection.Interfaces {
    ...
    /// <summary>Interface to decouple the `Analyzer` from the `Detector` it is using by default. Use this if you want to
    /// inject your own detector into the `Analyzer`. Feel free to start by copying the original `Detector` and adjust it
    ...
    public interface IDetector {
        ...
        /// <param name="sampleBlock">The block of samples to analyze. Its length should always match `Config.SampleBlockSize`
        /// except when the end of the input has been reached, in which case it might be smalller once.</param>
